  ...
  const handlePurchaseCancel = async (action) => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          user_id: userId,
          asset_symbol: insurance.id,
          asset_type: "insurance", // Identify as insurance
          price: parseFloat(insuranceInfo.price),
          quantity: quantity,
          transaction_type: action === "purchase" ? "buy" : "sell", // Map to buy/sell for backend
        },
