...
export function VirtualBondDetail() {
  ...
  const handleBuySell = async (action) => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          user_id: userId,
          virtual_asset_symbol: bondId,
          virtual_asset_type: "bond", // Added to identify this as a bond transaction
          virtual_price: parseFloat(bondInfo.price),
